...
public class ModificarDatos extends javax.swing.JFrame {
     ...
     */
    public ModificarDatos(int numClie) {
    ...
    private void initComponents() {
        ...
        btnModificar.setIcon(new javax.swing.ImageIcon("C:\\Users\\usuario\\Documents\\NetBeansProjects\\PracticaPeluCan\\guardar.png")); // NOI18N
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        control.editarMascota(masco,nomMasco, raza, color, nomDueno, movDueno, observ, 
                alergico, attEsp);
    ...
    private void cargarDatos(int numClie) {
        this.masco = control.traeMascota(numClie);
        
        txtNomPerro.setText(masco.getNombre());
        txtRaza.setText(masco.getRaza());
        txtColor.setText(masco.getColor());
        txtNomDueno.setText(masco.getUnDuenio().getNombre());
        txtMovDueno.setText(masco.getUnDuenio().getNum_movil());
